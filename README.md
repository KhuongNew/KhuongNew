<!-- README: Genshin-style profile for KhuongNew (EN) | Animated effects, quote, badges -->
...
<p align="left">
  ...
  <a href="https://github.com/KhuongNew/icpc-templates"><img height="120" src="https://github-readme-stats.vercel.app/api/pin/?username=KhuongNew&repo=icpc-templates&theme=tokyonight&hide_border=true"/></a>
</p>

<details>
<summary>📘 One‑liners</summary>

* **D‑cine – Cinema Management** · Java + MySQL · ticket QR, seat map, revenue reports (MVC → Spring Boot planned).
* **Hotel Booking – Agile Lab 2** · Java/JavaFX + DB · Use‑Case/Sequence/ERD · mini CI & group docs.
* **Student Manager – C++/Qt** · CRUD, filters, GPA, CSV/SQL I/O.
* **ICPC Templates** · C++/Python snippets: DSU, PBDS, Graph, DP, debug macros.
...
<!-- Optional: Contribution Snake (needs a workflow). See https://github.com/Platane/snk for setup. -->
